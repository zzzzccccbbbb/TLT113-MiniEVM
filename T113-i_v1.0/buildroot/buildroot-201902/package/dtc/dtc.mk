...
define DTC_BUILD_CMDS
	$(TARGET_CONFIGURE_OPTS) $(MAKE) CFLAGS="$(TARGET_CFLAGS) -fPIC -fcommon" -C $(@D) $(DTC_MAKE_OPTS)
endef
...
# host build
# -fcommon: tolerate yylloc in lexer+parser on GCC 10+ (-fno-common default)
define HOST_DTC_BUILD_CMDS
	$(HOST_CONFIGURE_OPTS) $(MAKE) CFLAGS="$(HOST_CFLAGS) -fPIC -fcommon" -C $(@D) $(HOST_DTC_MAKE_OPTS)
endef
