...
SUNXI_MALI_DEPENDENCIES = libump libdrm wayland
...
SUNXI_MALI_MAKE_OPTS += EGL_TYPE=wayland
endif
else
...
ifeq ($(BR2_PACKAGE_SUNXI_MALI_R6P2),y)
SUNXI_MALI_MAKE_OPTS += VERSION=r6p2
endif
ifeq ($(BR2_PACKAGE_SUNXI_MALI_R8P1),y)
SUNXI_MALI_MAKE_OPTS += VERSION=r8p1
endif


ifeq ($(BR2_PACKAGE_SUNXI_MALI_R6P2),y)
define SUNXI_MALI_EXTRACT_TARGET_LIBS
	tar -jxf package/sunxi-mali/sunxi-mali-r6p2.tar.bz2 -C $(@D)/lib/mali/
endef
endif

ifeq ($(BR2_PACKAGE_SUNXI_MALI_R8P1),y)
define SUNXI_MALI_EXTRACT_TARGET_LIBS
	tar -jxf package/sunxi-mali/sunxi-mali-r8p1.tar.bz2 -C $(@D)/lib/mali/
endef
endif

define SUNXI_MALI_CONFIGURE_CMDS
	$(SUNXI_MALI_EXTRACT_TARGET_LIBS)
endef
...
define SUNXI_MALI_INSTALL_STAGING_CMDS
	...
	$(INSTALL) -D -m 0644 package/sunxi-mali/gbm.pc \
		$(STAGING_DIR)/usr/lib/pkgconfig/gbm.pc
	$(INSTALL) -D -m 0644 package/sunxi-mali/wayland-egl.pc \
