...
define PPPD_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -m 755 -D package/pppd/quectel-chat-connect \
		$(TARGET_DIR)/etc/ppp/peers/quectel-chat-connect
	$(INSTALL) -m 755 -D package/pppd/quectel-chat-disconnect \
		$(TARGET_DIR)/etc/ppp/peers/quectel-chat-disconnect
	$(INSTALL) -m 755 -D package/pppd/quectel-pppd.sh \
		$(TARGET_DIR)/etc/ppp/peers/quectel-pppd.sh
	$(INSTALL) -m 755 -D package/pppd/quectel-ppp-kill \
		$(TARGET_DIR)/etc/ppp/peers/quectel-ppp-kill
	$(INSTALL) -m 755 -D package/pppd/ip-up \
		$(TARGET_DIR)/etc/ppp/ip-up
	$(PPPD_INSTALL_RADIUS)
endef
