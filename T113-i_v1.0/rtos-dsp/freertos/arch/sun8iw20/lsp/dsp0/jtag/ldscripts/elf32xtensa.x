/* This linker script generated from xt-genldscripts.tpp for LSP ./arch/sun8iw20/lsp/dsp0_jtag */
...
MEMORY
{
  ...
  ddr1_0_seg :                        	org = 0x42000000, len = 0x100000
}
...
_memmap_mem_iram0_start = 0x400000;
_memmap_mem_iram0_end   = 0x410000;
_memmap_mem_ddr1_start = 0x42000000;
_memmap_mem_ddr1_end   = 0x42100000;

/*  Memory segment boundary addresses:  */
_memmap_seg_iram0_0_start = 0x400000;
_memmap_seg_iram0_0_max   = 0x400660;
_memmap_seg_iram0_1_start = 0x400660;
_memmap_seg_iram0_1_max   = 0x401000;
_memmap_seg_iram0_2_start = 0x401000;
_memmap_seg_iram0_2_max   = 0x40117c;
_memmap_seg_iram0_3_start = 0x40117c;
_memmap_seg_iram0_3_max   = 0x40119c;
_memmap_seg_iram0_4_start = 0x40119c;
_memmap_seg_iram0_4_max   = 0x4011bc;
_memmap_seg_iram0_5_start = 0x4011bc;
_memmap_seg_iram0_5_max   = 0x4011dc;
_memmap_seg_iram0_6_start = 0x4011dc;
_memmap_seg_iram0_6_max   = 0x4011fc;
_memmap_seg_iram0_7_start = 0x4011fc;
_memmap_seg_iram0_7_max   = 0x40121c;
_memmap_seg_iram0_8_start = 0x40121c;
_memmap_seg_iram0_8_max   = 0x40123c;
_memmap_seg_iram0_9_start = 0x40123c;
_memmap_seg_iram0_9_max   = 0x410000;
_memmap_seg_ddr1_0_start = 0x42000000;
_memmap_seg_ddr1_0_max   = 0x42100000;

_rom_store_table = 0;
PROVIDE(_memmap_reset_vector = 0x400660);
PROVIDE(_memmap_vecbase_reset = 0x401000);
/* Various memory-map dependent cache attribute settings: */
_memmap_cacheattr_wb_base = 0x00000402;
_memmap_cacheattr_wt_base = 0x00000102;
_memmap_cacheattr_bp_base = 0x00000202;
_memmap_cacheattr_unused_mask = 0xFFFFF0F0;
_memmap_cacheattr_wb_trapnull = 0x22222422;
_memmap_cacheattr_wba_trapnull = 0x22222422;
_memmap_cacheattr_wbna_trapnull = 0x22222522;
_memmap_cacheattr_wt_trapnull = 0x22222122;
_memmap_cacheattr_bp_trapnull = 0x22222222;
_memmap_cacheattr_wb_strict = 0xFFFFF4F2;
_memmap_cacheattr_wt_strict = 0xFFFFF1F2;
_memmap_cacheattr_bp_strict = 0xFFFFF2F2;
_memmap_cacheattr_wb_allvalid = 0x22222422;
_memmap_cacheattr_wt_allvalid = 0x22222122;
_memmap_cacheattr_bp_allvalid = 0x22222222;
_memmap_region_map = 0x00000005;
...
SECTIONS
{
  ...
  .ddr1.rodata : ALIGN(4)
  {
    _ddr1_rodata_start = ABSOLUTE(.);
    *(.ddr1.rodata)
    . = ALIGN (4);
    _ddr1_rodata_end = ABSOLUTE(.);
  ...
  .ddr1.data : ALIGN(4)
  {
    _ddr1_data_start = ABSOLUTE(.);
    *(.ddr1.data)
    . = ALIGN (4);
    _ddr1_data_end = ABSOLUTE(.);
  } >ddr1_0_seg :ddr1_0_phdr
  ...
  .bss (NOLOAD) : ALIGN(8)
  {
    ...
    *(.ddr1.bss)
    ...
    _memmap_seg_ddr1_0_end = ALIGN(0x8);
  } >ddr1_0_seg :ddr1_0_bss_phdr

  PROVIDE(__stack = 0x42100000);
  _heap_sentry = 0x42100000;

  _memmap_mem_ddr1_max = ABSOLUTE(.);
