/* This linker script generated from xt-genldscripts.tpp for LSP ./arch/sun8iw20/lsp/dsp0_perf_mem */
/* Linker Script for default link */
MEMORY
{
  extra_mem_0_seg :                   	org = 0x32000000, len = 0x660
  extra_mem_1_seg :                   	org = 0x32000660, len = 0x9A0
  extra_mem_2_seg :                   	org = 0x32001000, len = 0x17C
  extra_mem_3_seg :                   	org = 0x3200117C, len = 0x20
  extra_mem_4_seg :                   	org = 0x3200119C, len = 0x20
  extra_mem_5_seg :                   	org = 0x320011BC, len = 0x20
  extra_mem_6_seg :                   	org = 0x320011DC, len = 0x20
  extra_mem_7_seg :                   	org = 0x320011FC, len = 0x20
  extra_mem_8_seg :                   	org = 0x3200121C, len = 0x20
  extra_mem_9_seg :                   	org = 0x3200123C, len = 0xFEDC4
}
...
_memmap_mem_extra_mem_start = 0x32000000;
_memmap_mem_extra_mem_end   = 0x32100000;

/*  Memory segment boundary addresses:  */
_memmap_seg_extra_mem_0_start = 0x32000000;
_memmap_seg_extra_mem_0_max   = 0x32000660;
_memmap_seg_extra_mem_1_start = 0x32000660;
_memmap_seg_extra_mem_1_max   = 0x32001000;
_memmap_seg_extra_mem_2_start = 0x32001000;
_memmap_seg_extra_mem_2_max   = 0x3200117c;
_memmap_seg_extra_mem_3_start = 0x3200117c;
_memmap_seg_extra_mem_3_max   = 0x3200119c;
_memmap_seg_extra_mem_4_start = 0x3200119c;
_memmap_seg_extra_mem_4_max   = 0x320011bc;
_memmap_seg_extra_mem_5_start = 0x320011bc;
_memmap_seg_extra_mem_5_max   = 0x320011dc;
_memmap_seg_extra_mem_6_start = 0x320011dc;
_memmap_seg_extra_mem_6_max   = 0x320011fc;
_memmap_seg_extra_mem_7_start = 0x320011fc;
_memmap_seg_extra_mem_7_max   = 0x3200121c;
_memmap_seg_extra_mem_8_start = 0x3200121c;
_memmap_seg_extra_mem_8_max   = 0x3200123c;
_memmap_seg_extra_mem_9_start = 0x3200123c;
_memmap_seg_extra_mem_9_max   = 0x32100000;

_rom_store_table = 0;
PROVIDE(_memmap_reset_vector = 0x32000660);
PROVIDE(_memmap_vecbase_reset = 0x32001000);
...
_memmap_cacheattr_wb_trapnull = 0x2222224F;
...
SECTIONS
{
  ...
  } >extra_mem_9_seg :extra_mem_9_bss_phdr

  PROVIDE(__stack = 0x32100000);
  _heap_sentry = 0x32100000;
