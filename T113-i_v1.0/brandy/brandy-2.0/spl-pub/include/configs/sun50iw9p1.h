...
/* for dram para store */
#define RTC_DRAM_MR6			8
#define RTC_DRAM_MR14			9
#define RTC_DRAM_TPR6			10
#define RTC_DRAM_TPR11			11
#define RTC_DRAM_TPR12			12
...
/*CPU vol for boot*/
#define CONFIG_SUNXI_CORE_VOL           1000
/*sys vol for boot*/
#define CONFIG_SUNXI_SYS_VOL           960
