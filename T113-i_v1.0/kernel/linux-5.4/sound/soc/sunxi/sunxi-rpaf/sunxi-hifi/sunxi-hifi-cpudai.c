...
static int __init sunxi_hifi_cpudai_driver_init(void)
{
	return platform_driver_register(&sunxi_hifi_cpudai_driver);
}
late_initcall(sunxi_hifi_cpudai_driver_init);

static void __exit sunxi_hifi_cpudai_driver_exit(void)
{
	platform_driver_unregister(&sunxi_hifi_cpudai_driver);
}
module_exit(sunxi_hifi_cpudai_driver_exit);
