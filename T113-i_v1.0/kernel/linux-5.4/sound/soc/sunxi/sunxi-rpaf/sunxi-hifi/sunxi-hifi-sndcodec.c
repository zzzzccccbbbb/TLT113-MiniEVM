...
static int __init sunxi_hifi_sndcodec_driver_init(void)
{
	return platform_driver_register(&sunxi_machine_driver);
}
late_initcall(sunxi_hifi_sndcodec_driver_init);

static void __exit sunxi_hifi_sndcodec_driver_exit(void)
{
	platform_driver_unregister(&sunxi_machine_driver);
}
module_exit(sunxi_hifi_sndcodec_driver_exit);
