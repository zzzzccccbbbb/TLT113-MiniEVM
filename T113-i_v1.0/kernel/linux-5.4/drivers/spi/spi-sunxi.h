...
#define SPI_BATC_REG		(0x3C)	/* Bit-Aligned transfer configure register */
#define SPI_BACC_REG		(0x40)	/* Bit-Aligned clock configure register */
#define SPI_TXBIT_REG		(0x34)	/* tx bit register */
#define SPI_RXBIT_REG		(0x48)	/* rx bit register */
...
#define SPI_BUF_STA_REG		(0x400)	/* buffer status register */
